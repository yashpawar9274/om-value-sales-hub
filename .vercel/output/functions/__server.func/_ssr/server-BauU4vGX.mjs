...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-BauU4vGX.js
var server_BauU4vGX_exports = /* @__PURE__ */ __exportAll({
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BzGGSwP4.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-C6PQqzYT.mjs").then((n) => n.t),
		import("./start-Cl_K5Lpu.mjs"),
...
//#endregion
export { createServerEntry, server_default as default, createCsrfMiddleware as n, createMiddleware as r, server_BauU4vGX_exports as t };
